...
local text = {
    ["mode_jump_ex"] = format("If you touch the  <effect=spooky><color, %.2f, %.2f, %.2f> flashing pink box</color no-space></effect>, your mode will change to <bold>JUMP EX</bold no-space>.\n \n  \n \n In JUMP EX mode, you can \n do <color>three jumps</color> in total!"
        , unpack(color['pink'])),
